...
<script src="assets/js/jquery-3.5.1.min.js"></script>
        ...
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="assets/images/twitter-logo.png" alt="" height="30px" width="30px" />
            </div>
          </div>
          ...
          <div class="grid-sidebar">
            ...
            <div class="wrapper-left-elements">
              ...
              <a class="wrapper-left-active" href=$user-username  style="margin-top: 4px"><strong>Profile</strong></a>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="#">Anonymous Account</a>
    <a class="dropdown-item" href="#">Public Account</a>
  </div>
</div>
