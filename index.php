            ...
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        <!-- <img class="login-bird" src="twitter-logo.png" alt="bird"> -->
                        <button class="login-small-display signin-btn pri-btn">Log in</button>
                        <span class="front-para">See what’s happening in Our Campus</span>
                        <span class="join">Campus</span>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 style="font-weight: 700;" class="modal-title" id="exampleModalLongTitle">Register For Free</h5>
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <section class="twt-features">
                <div class="features-div">
                    ...
                    <p>Stay updated on trending topics.</p>
            ...
            <footer>
                <ul>
                    ...
                    <li>© 2021 - Campus</li>
                    <li style="color:#1DA1F2;"><b>- Developed by anonymous -</b></li>
                </ul>
            </footer>
        </main>
